...
public class FPGenerator {
    ...
    /** Return a value equal (mod <code>polynomial</code>) to        <code>fp</code> and of degree less than <code>degree</code>. */
    ...
    /** Extends <code>f</code> with lower sixteen bits of <code>v</code>.        Does not reduce. */
...
//    }
    ...
    /** The standard 64-bit fingerprint generator using        <code>polynomials[0][64]</code>. */
    public static final FPGenerator std64 = make(polynomials[64][0], 64);

    /** A standard 32-bit fingerprint generator using        <code>polynomials[0][32]</code>. */
    public static final FPGenerator std32 = make(polynomials[32][0], 32);

    // Below added by St.Ack on 09/30/2004.
    /** A standard 40-bit fingerprint generator using        <code>polynomials[0][40]</code>. */
    public static final FPGenerator std40 = make(polynomials[40][0], 40);
    /** A standard 24-bit fingerprint generator using        <code>polynomials[0][24]</code>. */
